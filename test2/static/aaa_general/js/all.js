...
// code for changing language and setting cookie
...
function onScroll(event){
	...
	let topScroll = 0;
	if($('.menu-img-top').outerHeight()){
		topScroll = $('.main-header').outerHeight() + $('.menu-nav-static-js').outerHeight() - $('.menu-img-top').outerHeight() + 30;
	}else {
		topScroll = $('.main-header').outerHeight() + $('.menu-nav-static-js').outerHeight() + 30;
	}
