...
! function(t, e) {
    ...
    return function(t) {
        ...
        e = t.exports = n(4)(), e.push([t.id, ".carousel-3d-container[data-v-c06c963c]{min-height:1em;width:100%;position:relative;z-index:0;overflow:hidden;margin:0 auto;box-sizing:border-box}.carousel-3d-slider[data-v-c06c963c]{position:relative;margin:0 auto;transform-style:preserve-3d;-webkit-perspective:1000em;-moz-perspective:1000em;perspective:1000em}", ""])
    }, function(t, e) {
        t.exports = function() {
            var t = [];
        ...
        e.default = {
            ...
            methods: {
                ...
                setSize: function() {
                    this.$el.style.cssText += "height:" + this.slideHeight + "em;", this.$el.childNodes[0].style.cssText += "width:" + this.slideWidth + "em; height:" + this.slideHeight + "em;"
                }
            },
            mounted: function() {
        ...
        e = t.exports = n(4)(), e.push([t.id, ".carousel-3d-controls[data-v-43e93932]{position:absolute;top:50%;height:0;margin-top:-30em;left:0;width:100%;z-index:1000}.next[data-v-43e93932],.prev[data-v-43e93932]{width:60em;position:absolute;z-index:1010;font-size:60em;height:60em;line-height:60em;color:#333;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;text-decoration:none;top:0}.next[data-v-43e93932]:hover,.prev[data-v-43e93932]:hover{cursor:pointer;opacity:.7}.prev[data-v-43e93932]{left:10em;text-align:left}.next[data-v-43e93932]{right:10em;text-align:right}.disabled[data-v-43e93932],.disabled[data-v-43e93932]:hover{opacity:.2;cursor:default}", ""])
    }, function(t, e) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        t.exports = {
            render: function() {
                ...
                return n("div", {
                    ...
                    style: "width: " + t.width + "em; height: " + t.height + "em; line-height: " + t.height + "em;",
                    attrs: {
                        href: "#"
                    },
                    on: {
            ...
            computed: {
                ...
                slideStyle: function() {
                    ...
                    return (0, a.default)(t, {
                        "border-width": this.parent.border + "em",
                        width: this.parent.slideWidth + "em",
                        height: this.parent.slideHeight + "em",
            ...
            methods: {
                ...
                calculatePosition: function(t, e, n) {
                    var i = this.parent.disable3d ? 0 : parseInt(this.parent.inverseScaling) + 100 * (t + 1),
                        ...
                        s = e ? "translateX(" + o + "em) translateZ(-" + i + "em) rotateY(-" + r + "deg)" : "translateX(-" + o + "em) translateZ(-" + i + "em) rotateY(" + r + "deg)",
        ...
        t.exports = {
            render: function() {
                ...
                return n("div", {
                    ...
                    style: {
                        height: this.slideHeight + "em"
                    }
                }, [n("div", {
                    staticClass: "carousel-3d-slider",
                    style: {
                        width: this.slideWidth + "em",
                        height: this.slideHeight + "em"
                    }
