...
<!DOCTYPE html>
	...
	<head>
		<title><fmt:message key='page.title.resetpassword' /></title>
		...
		<div class="wrapper">
			<div class="row justify-content-between">
				<div class="col-md-6 col-lg-8">
					<h2 class="authorization-login"><fmt:message key='header.reset.password' /></h2>
					<div class="row">
						<div class="col-lg-6 col-md-11">
							<jsp:include page="/aaa_general/responsivelayout/resetpassword.jsp">
