...
<!DOCTYPE html>
	...
	<head>
		<title><fmt:message key='page.title.forgottenlogin' /></title>
		...
		<div class="wrapper">
			<div class="row">
				<div class="col-md-6 col-lg-8">
					<h2 class="authorization-login"><fmt:message key='header.forgot.login' /></h2>
					<div class="row">
						<div class="col-lg-6 col-md-11">
							<jsp:include page="/aaa_general/responsivelayout/forgotlogindetails.jsp">
