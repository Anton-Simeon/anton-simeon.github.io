...
<c:set var="pageTitle"><fmt:message key='page.title.becomedriver' /></c:set>
<!DOCTYPE html>
  		...
  		<div class="mainWrapp_scroll">
	  		<div class="mainWrapp">
				...
				<div class="containerWrapp container">
					<jsp:include page="/aaa_general/responsivelayout/become-a-driver.jsp">
						<jsp:param value="${pageTitle}" name="pageTitle"/>
						<jsp:param value="${driverSignUpToEmail}" name="emailTo"/>
					</jsp:include>
				</div>
			</div>
