...
<c:set var="pageTitle"><fmt:message key='page.title.verification' /></c:set>
<!DOCTYPE html>
	<jsp:include page="/aaa_general/language-support.jsp"/>
	<head>
		<title><fmt:message key='page.title.verification' /></title>
  		...
  		<div class="mainWrapp_scroll">
	  		<div class="mainWrapp">
				...
				<div class="containerWrapp container">
					<jsp:include page="/aaa_general/responsivelayout/verification.jsp">
