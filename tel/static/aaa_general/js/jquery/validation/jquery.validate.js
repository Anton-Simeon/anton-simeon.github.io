...
jQuery.validator = function( options, form ) {
	this.settings = $.extend( true, {}, jQuery.validator.defaults, options );
...
$.extend(jQuery.validator, {
	...
	setDefaults: function(settings) {
		$.extend( jQuery.validator.defaults, settings );
	},
	...
	prototype: {
		...
		optional: function(element) {
			return !jQuery.validator.methods.required.call(this, $.trim(element.value), element) && "dependency-mismatch";
		},
	...
	classRules: function(element) {
		...
		classes && $.each(classes.split(' '), function() {
			if (this in jQuery.validator.classRuleSettings) {
				$.extend(rules, jQuery.validator.classRuleSettings[this]);
			}
		});
		return rules;
	},
...
$.format = jQuery.validator.format;
